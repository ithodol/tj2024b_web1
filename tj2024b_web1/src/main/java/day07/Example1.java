...
public class Example1 {
	public static void main(String[] args) { // 실행 : Java Application
		...
		Box1 box1 = new Box1();
		box1.content = "안녕하세요"; // 인스턴스내 멤버변수의 값 대입
		String content1 = box1.content; // 인스턴스내 멤버변수의 값 호출/반환 // String 타입
		
		// [2] Box2 인스턴스 생성 new Box();
		Box2 box2 = new Box2();
		box2.content = 100;
		int content2 = box2.content;
		
		// [3] 특정 인스턴스의 하나의 멤버변수가 여러 타입을 가질 수 있는지?
		// (방법1) 다형성 : 다양한 타입으로 변환이 가능한 성질, 최상위 클래스 = Object // 타입변환 필요
		Box3 box3 = new Box3();
		...
		// (방법2) 제네릭타입 : 클래스내 멤버변수 타입을 인스턴스를 생성(new)할 때 정하기
		...
		ArrayList<Dto> dtoList = new ArrayList<Dto>();
			// * 게시물 1개 조회 : Dto 사용 // * 게시물 여러개 조회 : ArrayList<Dto> 사용
		
		// [5] 제네릭타입 여러개
		Point<String, Integer> point = new Point();
		point.value1 = "안녕하세요"; // 제네릭에 String 타입을 대입했기 때문에 가능
		point.value2 = 100;
